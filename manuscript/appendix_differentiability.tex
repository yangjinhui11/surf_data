...
double precision. The seasonal response maps of
Fig.~\ref{fig:seasonal-tair-sensitivity} resolve the spatial structure behind
the seasonal statistics of Table~\ref{tab:seasonal-tair-response}: the
threshold-sensitive columns cluster in snow-margin and high-elevation
regions rather than being distributed uniformly.
