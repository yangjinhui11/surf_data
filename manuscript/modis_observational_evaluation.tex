...
is 13.7~K against an observed 21.4~K. The annual mean model--observation
differences are mapped in Fig.~\ref{fig:modis-maps}: the daytime cold bias
is widespread but strongest over the arid northwest and the Tibetan Plateau,
while the nighttime bias stays small almost everywhere and the snow-cover
deficit concentrates along the seasonal snow margin. Where MODIS retrieves under the strict
...
The optimized profile is a projection of the model--observation
...
in two stages on the same ten autumn--winter days
(Fig.~\ref{fig:modis-structural-slab}). In the first stage the
