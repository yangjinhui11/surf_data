...
terminal step. The decadal terminal comparison is given in
Table~\ref{tab:multiyear-autonomous}, and the terminal fields are mapped on
the CMFD grid in Fig.~\ref{fig:multiyear-terminal-maps}.
